...
-   Then you need to save your copy. Click *File -\> Save as -\> Navigate to the file with your name on it (that we share) -\> Change the "LAST_NAME part of the file name to your last name -> Save*.
