...
We will use a combination of technologies in this course including R, and RStudio (server). I have set up an RStudio server that you will access with a web browser. You don’t need to install any software (in fact for a while I prefer you don’t). If you are an off campus student, please let me know right away.
...
Your homework will be graded for correctness. I will generally evaluate a random subset of the assigned questions. Your goal is to practice the application of the method and be able to interpret the result. You will find your homework and due dates on the homepage of the course website. 

##### Participation

This be measrued by your class (meeting) attendance, and your work on labs and class examples. With class work, please save your script files in the folder that I can view on the RStudio server. I will look at these files to see if you are following along.

#### Project

Your project will entail multiple stages of submission with details accessed through “Project” on the left side of the course website (once available). Some class time will be used for discussing projects but not enough to complete the project. I do not anticipate we will start these until week 3. You will need to use time series analysis and write a scrollytelling article about your results. If you have never heard of scrollytelling, check out [this NYT article](https://www.nytimes.com/2023/12/27/briefing/innovative-storytelling-from-2023.html) and this [shorthand website](https://shorthand.com/the-craft/scrollytelling-examples/index.html).. 
